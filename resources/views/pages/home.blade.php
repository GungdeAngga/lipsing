...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col" data-aos="fade-up" data-aos-delay="200">
            <a href="{{ route('jenis-investasi.filter', 'Peternakan') }}">
        ...
        <div class="col" data-aos="fade-up" data-aos-delay="300">
            <a href="{{ route('jenis-investasi.filter', 'Perikanan') }}">
                <div class="card-jenis-investasi mb-3">
                    <div class="container text-center">
        ...
        <div class="col" data-aos="fade-up" data-aos-delay="400">
            <a href="{{ route('jenis-investasi.filter', 'Perkebunan') }}">
                <div class="card-jenis-investasi mb-3">
                    <div class="container text-center">
        ...
        <div class="col" data-aos="fade-up" data-aos-delay="500">
            <a href="{{ route('jenis-investasi.filter', 'Pertanian') }}">
                <div class="card-jenis-investasi mb-3">
                    <div class="container text-center">
        ...
        <div class="col" data-aos="fade-up" data-aos-delay="600">
            <a href="{{ route('jenis-investasi.filter', 'Pariwisata') }}">
                <div class="card-jenis-investasi mb-3">
                    <div class="container text-center">
